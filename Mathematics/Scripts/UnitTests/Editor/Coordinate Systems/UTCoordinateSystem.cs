...
namespace ZkTools.Mathematics.UnitTests.Editor.CoordinateSystems
{
	internal class UTCoordinateSystem
	{
			...
			#region // ==============================[Methods]============================== //
				...
				{
					Vector3 Vec1 = new Vector3(-2.0f, 2.0f * MathF.Sqrt(3.0f), -2.0f);
				...
				public void CylindricalToCartesian ()
				{
					...
					Vector3 expected1 = new Vector3(-2.0f, 2.0f * MathF.Sqrt(3.0f), -2.0f);
					...
					Vector3 result2 = CoordinateSystem.CylindricalToCartesian(cyl2.rho, cyl2.theta, cyl2.z);
					AssertX.AreEqual(expected2, result2, delta);
				...
				public void CylindricalToSpherical ()
				{
					...
					SphericalCoord result2 = CoordinateSystem.CylindricalToSpherical(cyl2.rho, cyl2.theta, cyl2.z);
					AssertX.AreEqual(expected2, result2, delta);
