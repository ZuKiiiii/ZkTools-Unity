...
namespace ZkTools.Mathematics.CoordinateSystems
{
	...
	public static class CoordinateSystem
	{
		#region // ==============================[Static Methods]============================== //
			...
			public static Vector3 CylindricalToCartesian (float p_cylRho, float p_cylPhi, float p_cylZ)
			{
			...
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public static void CylindricalToCartesian (float p_cylRho, float p_cylPhi, float p_cylZ, out Vector3 p_vector3)
			{
			...
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public static SphericalCoord CylindricalToSpherical (float p_cylRho, float p_cylPhi, float p_cylZ)
			{
			...
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public static void CylindricalToSpherical (float p_cylRho, float p_cylPhi, float p_cylZ, out SphericalCoord p_sphericalCoord)
			{
			...
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public static void CylindricalToSpherical (CylindricalCoord p_cylindricalCoord, out float p_sphereRadius, out float p_sphereTheta, out float p_spherePhi)
			{
			...
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public static Vector2 PolarToCartesian (float p_polarRadius, float p_polarAngle)
			{
			...
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public static void PolarToCartesian (float p_polarRadius, float p_polarAngle, out Vector2 p_vector2)
			{
				PolarToCartesian(p_polarRadius, p_polarAngle, out p_vector2.x, out p_vector2.y);
			}

			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public static Vector3 SphericalToCartesian (float p_sphereRadius, float p_sphereTheta, float p_spherePhi)
			{
			...
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public static void SphericalToCartesian (float p_sphereRadius, float p_sphereTheta, float p_spherePhi, out Vector3 p_vector3)
			{
			...
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public static CylindricalCoord SphericalToCylindrical (float p_sphereRadius, float p_sphereTheta, float p_spherePhi)
			{
			...
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public static void SphericalToCylindrical (float p_sphereRadius, float p_sphereTheta, float p_spherePhi, out CylindricalCoord p_cylindricalCoord)
			{
			...
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public static void SphericalToCylindrical (SphericalCoord p_sphericalCoord, out float p_cylRho, out float p_cylPhi, out float p_cylZ)
			{
			...
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public static void CartesianToPolar (PolarCoord p_polarCoord, out float p_x, out float p_y)
			{
				CartesianToPolar(p_polarCoord.radius, p_polarCoord.angle, out p_x, out p_y);
			}
			...
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public static void CartesianToSpherical (Vector3 p_vector3, out float p_sphereRadius, out float p_sphereTheta, out float p_spherePhi)
			{
			...
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public static void CartesianToCylindrical (Vector3 p_vector3, out float p_cylRho, out float p_cylPhi, out float p_cylZ)
			{
